...
manager.register('u', 'Show user info command', ShowUserInfoCommand)
manager.register('t', 'Show user timeline command', ShowUserTimelineCommand)
...
manager.register('rr', 'Show recursive reply to status command', ShowRecursiveReplyToStatusCommand)
manager.register('cr', 'retweet command', RetweetCommand)
manager.register('rt', 'Unofficial retweet command', UnofficialRetweetCommand)
