...
alias cos='cd /data/share/temp/_cos'
alias av='cd /data/share/temp/_av'
alias doj='cd /data/share/temp/_dojin'
alias mng='cd /data/share/temp/_manga'
...
alias ae='python /data/share/movie/sh/ae.py'
...
alias dibot='kill `cat /data/share/movie/sh/python-lib/discordbot_dice.pid`; sleep 1; nohup python /data/share/movie/sh/python-lib/discord_dice_bot.py > /dev/null &'
alias gp='git pull'
alias gps='git push'
